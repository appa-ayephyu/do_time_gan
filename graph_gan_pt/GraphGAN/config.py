...
gen_interval = (
    n_epochs_gen  # sample new nodes for the generator for every gen_interval iterations
)
...
# path settings
data_root = "./graph_gan_pt/data/" + app + "/" + dataset + "/"
...
# pretrain_embedding
pretrain_emb_filename_d = (
    "./graph_gan_pt/pre_train/" + app + "/" + dataset + "_pre_train.emb"
)
pretrain_emb_filename_g = (
    "./graph_gan_pt/pre_train/" + app + "/" + dataset + "_pre_train.emb"
)

# embedding
emb_filenames = [
    "./graph_gan_pt/results/" + app + "/" + dataset + "_gen_.emb",
    "./graph_gan_pt/results/" + app + "/" + dataset + "_dis_.emb",
]

result_filename = "./graph_gan_pt/results/" + app + "/" + dataset + ".txt"

cache_filename = "./graph_gan_pt/cache/" + app + "/" + dataset + ".pkl"

train_detail_filename = [
    "./graph_gan_pt/results/" + app + "/" + "gen_detail/" + dataset + ".txt",
    "./graph_gan_pt/results/" + app + "/" + "dis_detail/" + dataset + ".txt",
]

# model_log = "../../log/"
dis_state_dict_filename = "./graph_gan_pt/model_params/" + dataset + "_dis.pt"
gen_state_dict_filename = "./graph_gan_pt/model_params/" + dataset + "_gen.pt"
