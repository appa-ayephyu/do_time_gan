...
import numpy as np
import torch
from graph_gan_pt.GraphGAN import config
from graph_gan_pt.GraphGAN import generator
from graph_gan_pt.GraphGAN import discriminator
            ...
            for d_epoch in range(config.n_epochs_dis):
                ...
                for start in start_list:
                    ...
                    loss = torch.nn.MultiLabelSoftMarginLoss(
                        self.discriminator.score, np.array(labels[start:end])
                    ).sum(0)
